...
export default {
  ...
  methods: {
      ...
      validate(mode = 'all'){
         ...
         if (this.city === null) { error = "city missing!"; scrollTo = 'city-input';}
         else{ if (this.city.length < 1) { error = "city missing!"; scrollTo = 'city-input'; } }

         if (this.country === null) { error = "country missing!"; scrollTo = 'country-input';}
         else{ if (this.country.length < 1) { error = "country missing!"; scrollTo = 'country-input'; } }

         if (this.address === null) { error = "street missing!"; scrollTo = 'street-input';}
         else{ if (this.address.length < 1) { error = "street missing!"; scrollTo = 'street-input'; } }

         if (this.phone === null) { error = trans.vars.Notifications.phoneRequired; scrollTo = 'phone-input';  }
         else{ if (this.phone.length < 1) { error = trans.vars.Notifications.phoneRequired; scrollTo = 'phone-input'; }}

         if (this.email === null) { error = trans.vars.Notifications.emailRequired; scrollTo = 'email-input'; }
         else{ if (this.email.length < 1) { error = trans.vars.Notifications.emailRequired; scrollTo = 'email-input'; } }

         if (this.name === null) { error = trans.vars.Notifications.nameRequired; scrollTo = 'name-input'; }
         else{ if (this.name.length < 1) { error = trans.vars.Notifications.nameRequired; scrollTo = 'name-input'; } }
