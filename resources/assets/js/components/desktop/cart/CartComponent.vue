            ...
            <div class="col-12" v-if="ready">
                                ...
                                <span >
                                    <svg width="31px" height="26px" viewBox="0 0 31 26" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        <g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                            <g id="project_20200129_150142" transform="translate(-1443.000000, -66.000000)" fillRule="nonzero">
                                                    ...
                                                    <g id="Group-16" transform="translate(356.500000, 1055.000000)">
                                                        <g id="Shape-3" transform="translate(1445.500000, 66.000000)">
                                                            <path
                                                                ...
                                                                id="Shape" fill="none" opacity="0.916666667"></path>
                                                            <path
                ...
                <div class="row cartItem" v-for="(cartProd, key) in cartProds">
                    ...
                    <div class="price col-auto">
                        ...
                        <span v-if="cartProd.product.main_price.price !== cartProd.product.main_price.old_price">
                            {{ cartProd.product.main_price.old_price * cartProd.qty }}
                            {{ $mainCurrency }}
                        </span>
                        <span v-else></span>
                    </div>
