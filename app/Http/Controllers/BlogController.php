...
class BlogController extends Controller
{
    ...
    {
        $blogs = Blog::where('first', 0)->orderby('date_time', 'desc')->get();
        $blogFirst = Blog::where('first', 1)->first();

        return view('front.blogs.list', compact('seoData', 'blogs', 'blogFirst'));
    }
    ...
    public function singleBlog($id)
    {
        ...
        return view('front.blogs.single', compact('seoData', 'blog'));
    }
